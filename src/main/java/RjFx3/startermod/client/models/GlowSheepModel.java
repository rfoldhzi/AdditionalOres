...
@OnlyIn(Dist.CLIENT)
public class GlowSheepModel<T extends GlowSheepEntity> extends QuadrupedModel<T> {
//public class GlowSheepModel<T extends GlowSheepEntity> extends SheepModel<SheepEntity> {
	private float headRotationAngleX;

	   public GlowSheepModel() {
