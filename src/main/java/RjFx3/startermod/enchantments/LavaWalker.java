...
public class LavaWalker extends Enchantment {
	public LavaWalker(String name, Enchantment.Rarity rarityIn, EquipmentSlotType... slots) {
   ...
   public void stoneNearby(LivingEntity living, World worldIn, BlockPos pos, int level) {
