...
public class CloudEntity extends MonsterEntity {
   private float heightOffset = 0.5F;
   private int heightOffsetUpdateTime;
   private static final DataParameter<Byte> ON_FIRE = EntityDataManager.createKey(CloudEntity.class, DataSerializers.BYTE);
   ...
   public static MutableAttribute getAttributes() {
		return MobEntity.registerAttributes()
				...
				.createMutableAttribute(Attributes.ATTACK_KNOCKBACK, 5F)
				.createMutableAttribute(Attributes.FOLLOW_RANGE, 32.0D);
	}
	public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
       return MobEntity.registerAttributes().createMutableAttribute(Attributes.MOVEMENT_SPEED, (double)0.3F).createMutableAttribute(Attributes.MAX_HEALTH, 8.0D).createMutableAttribute(Attributes.ATTACK_DAMAGE, 1F).createMutableAttribute(Attributes.ATTACK_KNOCKBACK, 5F).createMutableAttribute(Attributes.FOLLOW_RANGE, 32.0D);
   }
   
   protected void registerGoals() {
      this.goalSelector.addGoal(4, new CloudEntity.FireballAttackGoal(this));
   ...
   static class FireballAttackGoal extends Goal {
      private final CloudEntity blaze;
      private int attackStep;
      private int attackTime;
      private int firedRecentlyTimer;

      public FireballAttackGoal(CloudEntity blazeIn) {
         this.blaze = blazeIn;
